...
public:
    ...
    cv::Mat img_undist_, img_auxiliary_undist_, img_auxiliary_lf_undist_;
    torch::Tensor original_image_; ///< image
    int image_width_;              ///< image
    int image_height_;             ///< image
    torch::Tensor language_features_; ///< language features
    torch::Tensor original_depth_; ///< depth
    ...
    std::vector <torch::Tensor> gaus_pyramid_original_depth_; ///< gaus_pyramid depth
