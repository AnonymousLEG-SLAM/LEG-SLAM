...
//Copy Constructor
    Frame::Frame(const Frame &frame)
        ...
        imgAuxiliaryLF = frame.imgAuxiliaryLF;
    ...
    Frame::Frame(const cv::Mat &imLeft, const cv::Mat &imRight, const cv::Mat &imRGB, const cv::Mat &imRightRGB,
    ...
    Frame::Frame(const cv::Mat &imGray, const cv::Mat &imDepth, const cv::Mat &imRGB, const double &timeStamp,
    ...
    Frame::Frame(const cv::Mat &imGray, const cv::Mat &imDepth, const cv::Mat &imRGB, const cv::Mat &imLF, const double &timeStamp,
                 ORBextractor *extractor, ORBVocabulary *voc, cv::Mat &K, cv::Mat &distCoef, const float &bf,
                 const float &thDepth, GeometricCamera *pCamera, Frame *pPrevF, const IMU::Calib &ImuCalib)
            : mpcpi(NULL), mpORBvocabulary(voc), mpORBextractorLeft(extractor),
              mpORBextractorRight(static_cast<ORBextractor *>(NULL)),
        ...
        this->imgLeftRGB = imRGB.clone();
        this->imgAuxiliary = imDepth.clone();
        this->imgAuxiliaryLF = imLF.clone();
    ...
    Frame::Frame(const cv::Mat &imGray, const cv::Mat &imRGB, const double &timeStamp, ORBextractor *extractor,
