...
public:
    ...
    // Constructor for RGB-D-LF cameras.
    Frame(const cv::Mat &imGray, const cv::Mat &imDepth, const cv::Mat &imRGB, const cv::Mat &imLF, const double &timeStamp, ORBextractor* extractor,ORBVocabulary* voc, cv::Mat &K, cv::Mat &distCoef, const float &bf, const float &thDepth, GeometricCamera* pCamera,Frame* pPrevF = static_cast<Frame*>(NULL), const IMU::Calib &ImuCalib = IMU::Calib());
...
public:
    ...
    cv::Mat imgLeftRGB, imgAuxiliary, imgAuxiliaryLF;
