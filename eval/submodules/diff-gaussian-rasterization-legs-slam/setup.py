...
setup(
    name="diff_gaussian_rasterization_legs_slam",
    packages=['diff_gaussian_rasterization_legs_slam'],
    ext_modules=[
        CUDAExtension(
            name="diff_gaussian_rasterization_legs_slam._C",
            sources=[
            ...
            "ext.cpp"],
            extra_compile_args={
                "nvcc": ["-I" + os.path.join(os.path.dirname(os.path.abspath(__file__)), "third_party/glm/")] + cuda_arch_flags
            })
        ],
    cmdclass={
